...
* Go to the following URL, replacing the `client_id` in the URL with the one you obtained in the previous step and the domain of the `redirect_uri` with your own:
